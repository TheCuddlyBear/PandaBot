    ...
    exec: async (call) => {
        ...
        if(!vc){
            ...
            if(!serverQueue){
                ...
                call.message.channel.send("I have added all the songs from the playlist to the queue!").then(msg => {
                    msg.delete({ timeout: 10000 })
                })
                ...
                call.message.delete();
                return call.message.channel.send("I have added all the songs from the playlist to the queue!").then(msg => {
                    msg.delete({ timeout: 10000 })
                })
            }
        }
